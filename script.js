...
function buttonPress() {
    let elmnt = document.getElementById("PlayWme");
    elmnt.remove(); //remove initial button
}
...
let winnerPanel = document.getElementById("contSmall1");
...
function declareWinner(scoreP, scoreC) {
    ...
    if (scoreP > scoreC) {
        ...
        winner = 'I am the PC and I won! &#x1F60A';
    };

    winnerPanel.style = "z-index:5";

    wins.innerHTML = winner;
    wins.style = 'font-family: "Indie Flower"; font-weight: bold; font-size: 50px; color: #b44800; padding-top: 0px; padding-bottom: 5px; -webkit-text-stroke-width: 0.5px;-webkit-text-stroke-color: #b44800;';

    buts.innerHTML = 'Try Again?';
    buts.style = "font-family: Dancing Script; font-size: 40px; color: #f5cb94; border-radius: 20px; margin: 10px; padding: 5px; margin: 10px; margin-left: 150px; margin-right: 150px;";
};
